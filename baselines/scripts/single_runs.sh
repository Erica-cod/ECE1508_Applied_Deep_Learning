...
# python run_exp.py --monolithic --type ZS --fold_number 0  --LM llama-3.1  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
...
# python run_exp.py --monolithic --type FS --fold_number 0  --LM llama-3.1  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
...
# python run_exp.py  --type ZS --fold_number 0  --LM llama-3.1 --agg_func min  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
python run_exp.py  --type FS --fold_number 0  --LM gpt2 --agg_func min  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
# python run_exp.py  --type FS --fold_number 0  --LM llama-3.1 --agg_func min  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
...
# python run_exp.py  --type ZS --fold_number 0  --LM llama-3.1 --agg_func max  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
python run_exp.py  --type FS --fold_number 0  --LM gpt2 --agg_func max  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
# python run_exp.py  --type FS --fold_number 0  --LM llama-3.1 --agg_func max  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
...
# python run_exp.py  --type ZS --fold_number 0  --LM llama-3.1 --agg_func amean  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
python run_exp.py  --type FS --fold_number 0  --LM gpt2 --agg_func amean  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
# python run_exp.py  --type FS --fold_number 0  --LM llama-3.1 --agg_func amean  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
...
# python run_exp.py  --type ZS --fold_number 0  --LM llama-3.1 --agg_func gmean  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
python run_exp.py  --type FS --fold_number 0  --LM gpt2 --agg_func gmean  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
# python run_exp.py  --type FS --fold_number 0  --LM llama-3.1 --agg_func gmean  --result_root 1fold_runs --folds_path folds/1_fold_inds.json
