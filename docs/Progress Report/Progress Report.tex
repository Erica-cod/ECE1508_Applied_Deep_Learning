...
The architecture of all Llama models are Decoder-only. All evaluated models with their accuracy and whether they meet the 65\% threshold are summarized in Table~\ref{tab:llama_combined}.
\begin{table}[h]
\centering
...
\toprule
\textbf{Model} & \textbf{Parameters} & \textbf{Accuracy} & \textbf{Training Time}  & \textbf{VRAM}   & \textbf{Above Goal?} \\
\midrule
Fine-tuned Llama-3.2-3B  & 3.2B & \textbf{84.00\%} & 14 min &  6.4 GB  & Yes \\
